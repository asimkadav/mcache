...
iniglobals(void)
{
	...
	{	int l_in;
		...
		logval("b_act", now.b_act);
	{	int l_in;
		for (l_in = 0; l_in < 18; l_in++)
		{
			logval("c[l_in]", now.c[l_in]);
		}
	}
		logval("c_act", now.c_act);
#endif
...
{	/* int i; */
	switch(tp) {
	case 6:
		printf("local vars proc %d (CtoB):\n", pid);
		break;
	case 5:
		printf("local vars proc %d (CtoA):\n", pid);
		break;
	case 4:
		printf("local vars proc %d (BtoC):\n", pid);
		break;
	case 3:
		printf("local vars proc %d (BtoA):\n", pid);
		break;
	case 2:
		printf("local vars proc %d (AtoC):\n", pid);
		break;
	case 1:
		printf("local vars proc %d (AtoB):\n", pid);
		break;
	case 0:
		/* none */
		break;

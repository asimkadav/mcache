...
static int sections_per_bloc()
{
	return sections_per_block;
}
EXPORT_SYMBOL(sections_per_bloc);
...
EXPORT_SYMBOL(get_memory_block_size); //ASIM
...
unsigned long max_block_pindex;
static unsigned long get_max_block_pindex()
{
	return max_block_pindex;	
}
EXPORT_SYMBOL(get_max_block_pindex);
